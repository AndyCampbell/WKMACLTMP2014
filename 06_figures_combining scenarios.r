...
plot(0,0,xaxt="n",yaxt="n",cex=0,bty="n",bg="grey60")
text(0,0,paste("Ftarget=",fb[nb]),cex=1.2)
}



savePlot(file=paste(plotPathsc,"trajec.comp.Btrig",mpPoints$Btrigger,"_longtermweights.png",sep=""),type="png")
 dev.off()
