...
write.csv((diags),file=paste(outPath,"/tables_diags_HCR sensitivity ref selection pattern","_TACvarlim",TACvarlim,"_Fvarlim",Fvarlim,"_",BBscen,"_LastRec.csv",sep=""),row.names=T)
