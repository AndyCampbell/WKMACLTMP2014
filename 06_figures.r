...
scen          <- c("LTMP2.4mt")              # 
opt           <- 7                      # for multiple scenario combinations a counter
...
outPath<-paste(outPath,"HCR base case/",sc.name,"/",sep="")
...
fonts <- 2
  ...
  #-------------------------------------------------------------------------------
plotPathsc<-paste( "W:/IMARES/Data/ICES-WG/WKMACLTMP/Results/figures input output/",scen,opt,sep="")
...
legend("topleft",lty=c(0,0),c(paste("Btrigger=",mpPoints$Btrigger),paste("Ftarget=",mpPoints$Ftarget)))       
dev.off()
...
savePlot(file=paste(plotPath2,"13.Risk.png",sep=""),type="png");dev.off()
...
savePlot(file=paste(plotPath2,"14.meanW.png",sep=""),type="png");dev.off()
...
savePlot(file=paste(plotPath2,"15.meanAge.png",sep=""),type="png");dev.off()
...
savePlot(file=paste(plotPath2,"16.iterations.png",sep=""),type="png");dev.off()
