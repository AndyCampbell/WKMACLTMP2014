...
save.image(file=paste(outPath2,"plots Sensitivity Perm/",scen,opt,nits,"its",prlength2,"yrs_resMSY.RData",        sep=""))
}
...
load(file=paste(outPath2,"plots Sensitivity Perm/",scen,opt,nits,"its",prlength2,"yrs_resMSY.RData",        sep=""))
...
png(file=paste(outPath2,"plots Sensitivity Perm/plot_equilibrium_and_risks",prlength2,"_",nYrMean,".png",sep=""),width=12,height=4,units="in",res=200)
...
png(file=paste(outPath2,"plots Sensitivity Perm/densityMSY_and_risks",prlength2,"_",nYrMean,".png",sep=""),width=8,height=8,units="in",res=200)
...
png(file=paste(outPath2,"plots Sensitivity Perm/otherRefPoints",prlength2,"_",nYrMean,".png",sep=""),width=8,height=8,units="in",res=200)
