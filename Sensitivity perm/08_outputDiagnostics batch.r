...
outPath<-"/media/n/Projecten/WKMACLTMP/Results/"
...
write.csv((diags),file=paste(outPath,"/tables_diags_HCR sensitivity perm","_TACvarlim",TACvarlim,"_Fvarlim",Fvarlim,"_",BBscen,"_LastRec.csv",sep=""),row.names=T)
