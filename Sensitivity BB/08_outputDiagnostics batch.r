...
opti<-c(7,7,8,8,9,9,10)
bt<-c("2.0mt","2.2mt","2.2mt","2.4mt","2.6mt","2.8mt","3.0mt")
...
write.csv((diags),file=paste(outPath,"/tables_diags_HCR sensitivity BB",run,"_TACvarlim",TACvarlim,"_Fvarlim",Fvarlim,"_","_LastRec.csv",sep=""),row.names=T)
