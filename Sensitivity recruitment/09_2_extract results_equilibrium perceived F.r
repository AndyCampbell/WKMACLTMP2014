...
load(file=paste(outPathp,"stocks.RData",         sep=""))
 ...
 scen          <- "equilPerc"              # 
 opt           <- "Rickeronly"                      # for multiple scenario combinations a counter
...
save.image(file=paste(outPath2,"plots sensitivity Recruitment/",scen,opt,nits,"its",prlength2,"yrs_resMSY.RData",        sep=""))
}
...
load(file=paste(outPath2,"plots sensitivity Recruitment/",scen,opt,nits,"its",prlength2,"yrs_resMSY.RData",        sep=""))
...
png(file=paste(outPath2,"plots sensitivity Recruitment/plot_equilibrium_and_risks",prlength2,"_",nYrMean,".png",sep=""),width=12,height=4,units="in",res=200)
...
png(file=paste(outPath2,"plots sensitivity Recruitment/densityMSY_and_risks",prlength2,"_",nYrMean,".png",sep=""),width=8,height=8,units="in",res=200)
...
png(file=paste(outPath2,"plots sensitivity Recruitment/otherRefPoints",prlength2,"_",nYrMean,".png",sep=""),width=8,height=8,units="in",res=200)
