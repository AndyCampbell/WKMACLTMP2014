...
write.csv((diags),file=paste(outPath,"/risk vs iters/tables_diags_HCR base case1000","_TACvarlim",TACvarlim,"_Fvarlim",Fvarlim,"_",BBscen,"_LastRec.csv",sep=""),row.names=T)
