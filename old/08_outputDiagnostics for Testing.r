...
write.csv(t(diags),file=paste(outPath,"/tables_diags_rev_perm_sensitivity_test",scen,opt,"_TACvarlim",TACvarlim,"_Fvarlim",Fvarlim,"_",BBscen,"_LastRec.csv",sep=""),row.names=T)
