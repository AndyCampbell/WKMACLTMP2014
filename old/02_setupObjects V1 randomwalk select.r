...
# a simple mean for sensitivity tests
if( BiolType == "ARMAperm")
{ 

# load the objects previously generated
load(paste(inPath," ARMAperm_fprop.RData",sep=""))
load(paste(inPath," ARMAperm_mprop.RData",sep=""))
load(paste(inPath," ARMAperm_stock.wt.RData",sep=""))
load(paste(inPath," ARMAperm_catch.wt.RData",sep=""))
load(paste(inPath,"ARMAperm_mat.RData",sep=""))
...
outPath<-paste(outPath,"perm",sep="")  
